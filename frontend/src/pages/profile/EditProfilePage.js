...
const EditProfilePage = () => {
    ...
    const changeHandler = async (event) => {
        ...
        // });
        // try {
        //     const data = await fetch('http://localhost:3100/api/profile/img', {
        //         method: 'POST',
        //         body: formData
        //     });
            ...
            {modalOpen &&
                <Fragment>
                    <div className={`card ${classes['profile-edit-card']}`}>
                        {profileImg && <ImageCropper image={profileImg} close={modalClose} update={updateProfileImg} loading={isProfileImgLoading} />}
                    </div>
                    <div className={classes.backdrop} onClick={modalClose}>
                    </div>
                </Fragment>
            }
