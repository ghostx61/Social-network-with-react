    ...
    return (
        ...
        <div className="card">
            <div className={`card-body ${classes['card-top']}`}>
                <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/2/24/LEGO_logo.svg/2048px-LEGO_logo.svg.png" alt="Post" className={classes['profile-pic']} />
                <div className={classes['card-top-right']}>
                    <p className={classes['username']}>Ninad Hatankar</p>
                    <p className={classes['post-date']}>6 July 2021</p>
                </div>
            </div>
            {/* <p>Test ing the feature</p> */}
            <img src="https://images.unsplash.com/photo-1438761681033-6461ffad8d80?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80" alt="Post" />
            <div className={`card-body ${classes['card-bottom']}`}>
                <span className={classes['like-btn']}>
                    {likeSvg} 3,022
                </span>
                <span>
                    {commentSvg} 100
                ...
                <p className={classes['post-text']}>
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Harum obcaecati ipsum sint dignissimos similique! Vitae.
                </p>
                {/* <hr /> */}
                <div>
                ...
                <p className={classes['view-more-comments']}>view more comments</p>
                {/* <p>3,022 likes</p> */}
            </div>
        </div >
        // </Fragment>
